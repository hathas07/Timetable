...
public class TimeTableController implements ITimeTableController{
	...
	public boolean saveDB() {
		...
		try {
			...
			System.out.print("La base de données n'a pas pu être sauvegardé correctement : " +e);
			result = false;
		}
		return result;
	}
	...
	public boolean loadDB() {
		...
		try {
			...
			System.out.print("La base de données n'a pas pu être chargé correctement : " +e);
			result = false;
		}
		return result;
	}
